 ...
 * @LastEditTime: 2024-07-06 23:19:02
 * @FilePath: \Ripples\module\card_list.php
 */
...
<div class="container mx-auto px-4">
    <div class="space-y-6 m-8">
        <?php while ($this->next()): ?>
        <div
            class="card flex flex-col md:flex-row items-center bg-base-100 shadow-xl post hover:shadow-2xl transition duration-300 transform hover:-translate-y-1 hover:scale-105 p-4">
            <!-- 文章封面 -->
            <figure class="card w-full md:w-1/4">
                <img src="https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg" alt="Shoes"
                    class="rounded-lg" />
            </figure>

            <div class="card-body w-full md:w-3/4 pl-4">
                <h2 class="card-title">
                    <!-- 文章标题 -->
                    <?php $this->title() ?>
                </h2>
